import {CodeMirror} from '../simple-mode.js';

/**
 * @source https://github.com/WebAssembly/wabt/tree/1.0.13/demo/third_party/codemirror
 *
 ...
 *
 */
export const wast = CodeMirror.defineSimpleMode('wast', {
  start: [
    {
