import { Position, CompletionItemKind, Range, TextEdit, InsertTextFormat, MarkedString, Location, DocumentHighlightKind, SymbolKind, Command, DiagnosticSeverity, DiagnosticRelatedInformation, Diagnostic, TextDocumentEdit, WorkspaceEdit, WorkspaceChange, TextDocumentIdentifier, VersionedTextDocumentIdentifier, TextDocumentItem, MarkupKind, MarkupContent, CompletionItem, CompletionList, Hover, ParameterInformation, SignatureInformation, DocumentHighlight, SymbolInformation, CodeActionKind, CodeActionContext, CodeAction, CodeLens, FormattingOptions, DocumentLink, EOL, TextDocument, TextDocumentSaveReason } from '../../monaco/types.js';
