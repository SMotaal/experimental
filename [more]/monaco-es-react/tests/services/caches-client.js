import {html, idle, Component} from '../components/helpers.mjs';
...
export const register = async src => {
  ...
  const options = undefined; // {scope: './caches/'};
